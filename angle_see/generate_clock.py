...
def draw_clock(resolution, hour_hand_length, minute_hand_length, hour_color, minute_color, hour, minute):
    ...
    # Draw the clock face
    draw.ellipse((radius - radius, radius - radius, radius + radius, radius + radius), outline=(0, 0, 0))
    ...
    for i in range(12):
        ...
        draw.line((radius + 0.7*x, radius + 0.7*y, radius + x, radius + y),
                  fill=(0, 0, 0),
                  width=2)
